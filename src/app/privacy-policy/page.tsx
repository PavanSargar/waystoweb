...
const PrivacyPolicy = (props: Props) => {
  return (
    <div>
      ...
      <p>Effective date: 2021-04-29</p>
      <p>
        1. <strong>Introduction</strong>
      </p>
      <p>
        Welcome to <strong>Ways To Web</strong>.
      </p>
      <p>
        <strong>Ways To Web</strong> (“us”, “we”, or “our”) operates{" "}
        <strong>waystoweb.com</strong> (hereinafter referred to as{" "}
        <strong>“Service”</strong>).
      </p>
      <p>
        Our Privacy Policy governs your visit to <strong>waystoweb.com</strong>,
      ...
      <p>
        <strong>SERVICE</strong> means the waystoweb.com website operated by
        Ways To Web.
      </p>
      <p>
      ...
      <p>Ways To Web uses the collected data for various purposes:</p>
      ...
      <p>
        Ways To Web will take all the steps reasonably necessary to ensure that
      ...
      <p>
        ...
        <strong>contact@waystoweb.com</strong>.
      </p>
      <p>
      ...
      <p>
        ...
        at <strong>contact@waystoweb.com</strong>.
      </p>
      ...
      <p>
        19. <strong>Children’s Privacy</strong>
      </p>
      <p>
      ...
      <p>
        ...
        by email: <strong>contact@waystoweb.com</strong>.
      </p>
      <p>
        This <a href="https://policymaker.io/privacy-policy/">Privacy Policy</a>{" "}
        was created for <strong>waystoweb.com</strong> by{" "}
        <a href="https://policymaker.io">PolicyMaker.io</a> on 2021-04-29.
      </p>
    </div>
  );
};
