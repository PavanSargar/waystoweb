...
const Footer = (props: Props) => {
  return (
    <footer className="relative top-100 bg-darkBg pt-8 pb-6">
      {/* <div
          ...
          <div className="w-full lg:w-6/12 px-4">
            <div className="flex flex-wrap items-top mb-6">
              ...
              <div className="w-full lg:w-4/12 px-4">
                <span className="text-white block underline uppercase text-blueGray-500 text-sm font-semibold mb-2">
                  Other Resources
                </span>
                <ul className="list-unstyled">
                  {/* <li>
        ...
        <div className="flex flex-wrap items-center md:justify-between justify-center">
          <div className="w-full md:w-4/12 px-4 mx-auto text-center">
            <div className="text-sm text-white font-semibold py-1">
              Copyright © {new Date().getFullYear()} WaysToWeb | Built using
              NextJS
            </div>
          </div>
        </div>
